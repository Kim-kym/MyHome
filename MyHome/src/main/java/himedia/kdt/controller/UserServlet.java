...
import himedia.kdt.dao.UserDao;
import himedia.kdt.dao.UserDaoImpl;
...
public class UserServlet extends BaseServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("joinform".equals(actionName)) {
			...
			rd.forward(req, resp);
		} else if ("joinformsuccess".equals(actionName)) {
			RequestDispatcher rd =
					req.getRequestDispatcher("/WEB-INF/views/users/joinformsuccess.jsp");
			rd.forward(req, resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("join".equals(actionName)) {
			...
			if (success) {
				resp.sendRedirect(
						req.getContextPath() + "/users?a=joinformsuccess" );
			} else {
